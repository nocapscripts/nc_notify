$(document).ready(function () {
  ...
  const infoSvg = `
    <svg class="w-10 h-10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M12 7C12.5523 7 13 7.44772 13 8C13 8.55228 12.5523 9 12 9C11.4477 9 11 8.55228 11 8C11 7.44772 11.4477 7 12 7Z" fill="#1C274C"></path>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.25 12C1.25 6.06294 6.06294 1.25 12 1.25C17.9371 1.25 22.75 6.06294 22.75 12C22.75 17.9371 17.9371 22.75 12 22.75C6.06294 22.75 1.25 17.9371 1.25 12ZM12 2.75C6.89137 2.75 2.75 6.89137 2.75 12C2.75 17.1086 6.89137 21.25 12 21.25C17.1086 21.25 21.25 17.1086 21.25 12C21.25 6.89137 17.1086 2.75 12 2.75Z" class="icon-fill"></path>
      </g>
    </svg>`;
  ...
  function createNotification(type, message, fadeTime) {
    ...
    element.className = `notification-bg shadow-lg bg-zinc-700 border-b-4 rounded-sm border-orange-600`;
    element.innerHTML = `
      <i class="icon">${iconSvg}</i>
  ...
  // Event listener for messages if not in debug mode
  if (!debug) {
  ...
  // Debug notification
  if (debug) {
    createNotification('warning', 'Proovime seda  sitast teavituse riba. Proovige uuesti refreshides.', 5000);
  }
});
